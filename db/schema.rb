# This file is auto-generated from the current state of the database. Insteadq
...
ActiveRecord::Schema[7.0].define(version: 2023_03_09_191503) do
  ...
  create_table "notifications", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_medication_id"], name: "index_notifications_on_user_medication_id"
  end
  ...
  add_foreign_key "notifications", "user_medications"
